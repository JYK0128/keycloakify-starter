...
import { MessageKey_defaultSet } from 'keycloakify/login';
...
const messages = {
  ...
  'bypassKerberosDetail': 'Kerberos로 로그인되지 않았거나 브라우저가 Kerberos 로그인으로 설정되지 않았습니다. 다른 방법으로 로그인하려면 계속을 클릭하세요',
  'kerberosNotSetUp': 'Kerberos가 설정되지 않았습니다. 로그인할 수 없습니다.',
  'registerTitle': '회원가입',
  'loginAccountTitle': '계정에 로그인',
  'loginTitle': '{0}에 로그인',
  'loginTitleHtml': '{0}',
  'impersonateTitle': '{0} 사용자 대행',
  'impersonateTitleHtml': '<strong>{0}</strong> 사용자 대행',
  'realmChoice': '영역',
  'unknownUser': '알 수 없는 사용자',
  'loginTotpTitle': '모바일 인증앱 설정',
  'loginProfileTitle': '계정 정보 업데이트',
  'loginIdpReviewProfileTitle': '계정 정보 업데이트',
  'loginTimeout': '로그인 시도가 시간 초과되었습니다. 로그인을 처음부터 다시 시작합니다.',
  'reauthenticate': '계속하려면 다시 인증해주세요',
  'authenticateStrong': '계속하려면 강력한 인증이 필요합니다',
  'oauthGrantTitle': '{0}에 대한 액세스 권한 부여',
  'oauthGrantTitleHtml': '{0}',
  'oauthGrantInformation': '{0}이 귀하의 데이터를 어떻게 처리하는지 알아보고 {0}을 신뢰할 수 있는지 확인하세요.',
  'oauthGrantReview': '다음을 검토할 수 있습니다',
  'oauthGrantTos': '서비스 약관.',
  'oauthGrantPolicy': '개인정보처리방침.',
  'errorTitle': '죄송합니다...',
  ...
  'emailUpdateConfirmationSent': '확인 이메일이 {0}로 발송되었습니다. 이메일 업데이트를 완료하려면 해당 지침을 따라야 합니다.',
  'emailUpdatedTitle': '이메일 업데이트됨',
  'emailUpdated': '계정 이메일이 {0}로 성공적으로 업데이트되었습니다.',
  'updatePasswordTitle': '비밀번호 업데이트',
  'codeSuccessTitle': '성공 코드',
  'codeErrorTitle': '오류 코드: {0}',
  'displayUnsupported': '요청된 디스플레이 유형이 지원되지 않음',
  ...
  'termsTitle': '이용약관',
  'termsText': '<p>정의될 이용약관</p>',
  'termsPlainText': '정의될 이용약관.',
  ...
  'linkIdpActionMessage': '계정을 {0}과(와) 연결하시겠습니까?',
  ...
  'loginTotpStep1': '모바일에 다음 앱 중 하나를 설치하세요:',
  'loginTotpStep2': '앱을 열고 바코드를 스캔하세요:',
  'loginTotpStep3': '앱에서 제공하는 일회용 코드를 입력하고 제출을 클릭하여 설정을 완료하세요.',
  'loginTotpStep3DeviceName': 'OTP 기기를 관리하는 데 도움이 되는 기기 이름을 제공하세요.',
  'loginTotpManualStep2': '앱을 열고 키를 입력하세요:',
  'loginTotpManualStep3': '앱에서 허용하는 경우 다음 구성 값을 사용하세요:',
  'loginTotpUnableToScan': '스캔할 수 없나요?',
  'loginTotpScanBarcode': '바코드를 스캔하시겠습니까?',
  'loginCredential': '자격증명',
  ...
  'oauth2DeviceInvalidUserCodeMessage': '잘못된 코드입니다. 다시 시도해주세요.',
  'oauth2DeviceExpiredUserCodeMessage': '코드가 만료되었습니다. 기기로 돌아가서 다시 연결을 시도해주세요.',
  'oauth2DeviceVerificationCompleteHeader': '기기 로그인 성공',
  'oauth2DeviceVerificationCompleteMessage': '이 브라우저 창을 닫고 기기로 돌아가셔도 됩니다.',
  'oauth2DeviceVerificationFailedHeader': '기기 로그인 실패',
  'oauth2DeviceVerificationFailedMessage': '이 브라우저 창을 닫고 기기로 돌아가서 다시 연결을 시도해주세요.',
  'oauth2DeviceConsentDeniedMessage': '기기 연결에 대한 동의가 거부되었습니다.',
  'oauth2DeviceAuthorizationGrantDisabledMessage': '클라이언트가 OAuth 2.0 기기 인증 허가를 시작할 수 없습니다. 클라이언트에서 플로우가 비활성화되어 있습니다.',

  'emailVerifyInstruction1': '이메일 주소를 인증하는 방법에 대한 지침이 포함된 이메일이 {0} 주소로 발송되었습니다.',
  'emailVerifyInstruction2': '이메일로 인증 코드를 받지 못하셨나요?',
  'emailVerifyInstruction3': '이메일을 다시 보내려면 클릭하세요.',
  'emailVerifyInstruction4': '이메일 주소를 인증하기 위해 {0} 주소로 지침이 포함된 이메일을 발송하려고 합니다.',
  'emailVerifyResend': '인증 이메일 재발송',
  'emailVerifySend': '인증 이메일 발송',

  'emailLinkIdpTitle': '{0} 연결',
  'emailLinkIdp1': '{0} 계정 {1}을(를) {2} 계정과 연결하는 방법에 대한 지침이 포함된 이메일이 발송되었습니다.',
  ...
  'emailInstruction': '사용자명 또는 이메일 주소를 입력하시면 새 비밀번호 생성 방법에 대한 지침을 보내드립니다.',
  'emailInstructionUsername': '사용자명을 입력하시면 새 비밀번호 생성 방법에 대한 지침을 보내드립니다.',

  'copyCodeInstruction': '이 코드를 복사하여 애플리케이션에 붙여넣으세요:',

  'pageExpiredTitle': '페이지가 만료됨',
  ...
  'invalidUserMessage': '잘못된 사용자명 또는 비밀번호입니다.',
  ...
  'accountTemporarilyDisabledMessage': '잘못된 사용자명 또는 비밀번호입니다.',
  'accountPermanentlyDisabledMessage': '잘못된 사용자명 또는 비밀번호입니다.',
  'accountTemporarilyDisabledMessageTotp': '잘못된 인증 코드입니다.',
  'accountPermanentlyDisabledMessageTotp': '잘못된 인증 코드입니다.',
  'expiredCodeMessage': '로그인 시간이 초과되었습니다. 다시 로그인해주세요.',
  ...
  'missingFirstNameMessage': '이름을 입력해주세요.',
  'missingLastNameMessage': '성을 입력해주세요.',
  'missingEmailMessage': '이메일을 입력해주세요.',
  'missingUsernameMessage': '사용자명을 입력해주세요.',
  'missingPasswordMessage': '비밀번호를 입력해주세요.',
  'missingTotpMessage': '인증 코드를 입력해주세요.',
  'missingTotpDeviceNameMessage': '기기 이름을 입력해주세요.',
  'notMatchPasswordMessage': '비밀번호가 일치하지 않습니다.',

  'error-invalid-value': '잘못된 값입니다.',
  'error-invalid-blank': '값을 입력해주세요.',
  'error-empty': '값을 입력해주세요.',
  'error-invalid-length': '길이는 {1}자와 {2}자 사이여야 합니다.',
  ...
  'error-number-out-of-range': '숫자는 {1}과 {2} 사이여야 합니다.',
  ...
  'error-user-attribute-required': '이 필드를 입력해주세요.',
  ...
  'error-reset-otp-missing-id': 'OTP 구성을 선택해주세요.',

  'invalidPasswordExistingMessage': '기존 비밀번호가 잘못되었습니다.',
  'invalidPasswordBlacklistedMessage': '잘못된 비밀번호: 금지된 비밀번호입니다.',
  'invalidPasswordConfirmMessage': '비밀번호 확인이 일치하지 않습니다.',
  'invalidTotpMessage': '잘못된 인증 코드입니다.',

  'usernameExistsMessage': '이미 존재하는 사용자명입니다.',
  'emailExistsMessage': '이미 존재하는 이메일입니다.',

  'federatedIdentityExistsMessage': '{0} {1}을(를) 가진 사용자가 이미 존재합니다. 계정 관리에 로그인하여 계정을 연결해주세요.',
  'federatedIdentityUnavailableMessage': 'ID 제공자 {1}로 인증된 사용자 {0}이(가) 존재하지 않습니다. 관리자에게 문의하세요.',
  'federatedIdentityUnmatchedEssentialClaimMessage': 'ID 제공자가 발급한 ID 토큰이 구성된 필수 클레임과 일치하지 않습니다. 관리자에게 문의하세요.',

  'confirmLinkIdpTitle': '계정이 이미 존재함',
  'confirmOverrideIdpTitle': '브로커 링크가 이미 존재함',
  'federatedIdentityConfirmLinkMessage': '{0} {1}을(를) 가진 사용자가 이미 존재합니다. 어떻게 진행하시겠습니까?',
  'federatedIdentityConfirmOverrideMessage': '계정 {0}을(를) {1} 계정 {2}와(과) 연결하려고 합니다. 하지만 계정이 이미 다른 {3} 계정 {4}와(과) 연결되어 있습니다. 기존 링크를 새 계정으로 바꾸시겠습니까?',
  'federatedIdentityConfirmReauthenticateMessage': '{0}과(와) 계정을 연결하려면 인증하세요',
  'nestedFirstBrokerFlowMessage': '{0} 사용자 {1}이(가) 알려진 사용자와 연결되지 않았습니다.',
  'confirmLinkIdpReviewProfile': '프로필 검토',
  'confirmLinkIdpContinue': '기존 계정에 추가',
  'confirmOverrideIdpContinue': '예, 현재 계정으로 링크 재정의',

  'configureTotpMessage': '계정을 활성화하려면 모바일 인증앱을 설정해야 합니다.',
  ...
  'linkIdpMessage': '{0}과(와) 계정을 연결하려면 이메일 주소를 인증해야 합니다.',

  'emailSentMessage': '추가 지침이 포함된 이메일을 곧 받으실 수 있습니다.',
  'emailSendErrorMessage': '이메일 발송에 실패했습니다. 나중에 다시 시도해주세요.',

  'accountUpdatedMessage': '계정이 업데이트되었습니다.',
  'accountPasswordUpdatedMessage': '비밀번호가 업데이트되었습니다.',

  'delegationCompleteHeader': '로그인 성공',
  'delegationCompleteMessage': '이 브라우저 창을 닫고 콘솔 애플리케이션으로 돌아가셔도 됩니다.',
  'delegationFailedHeader': '로그인 실패',
  'delegationFailedMessage': '이 브라우저 창을 닫고 콘솔 애플리케이션으로 돌아가서 다시 로그인을 시도해주세요.',

  'noAccessMessage': '액세스 권한 없음',

  'invalidPasswordMinLengthMessage': '잘못된 비밀번호: 최소 길이는 {0}자입니다.',
  'invalidPasswordMaxLengthMessage': '잘못된 비밀번호: 최대 길이는 {0}자입니다.',
  'invalidPasswordMinDigitsMessage': '잘못된 비밀번호: 최소 {0}개의 숫자를 포함해야 합니다.',
  'invalidPasswordMinLowerCaseCharsMessage': '잘못된 비밀번호: 최소 {0}개의 소문자를 포함해야 합니다.',
  'invalidPasswordMinUpperCaseCharsMessage': '잘못된 비밀번호: 최소 {0}개의 대문자를 포함해야 합니다.',
  'invalidPasswordMinSpecialCharsMessage': '잘못된 비밀번호: 최소 {0}개의 특수문자를 포함해야 합니다.',
  'invalidPasswordNotUsernameMessage': '잘못된 비밀번호: 사용자명과 같을 수 없습니다.',
  'invalidPasswordNotContainsUsernameMessage': '잘못된 비밀번호: 사용자명을 포함할 수 없습니다.',
  'invalidPasswordNotEmailMessage': '잘못된 비밀번호: 이메일과 같을 수 없습니다.',
  'invalidPasswordRegexPatternMessage': '잘못된 비밀번호: 정규식 패턴과 일치하지 않습니다.',
  'invalidPasswordHistoryMessage': '잘못된 비밀번호: 최근 {0}개의 비밀번호와 같을 수 없습니다.',
  ...
  'standardFlowDisabledMessage': '클라이언트가 주어진 response_type으로 브라우저 로그인을 시작할 수 없습니다. 클라이언트에서 표준 플로우가 비활성화되어 있습니다.',
  'implicitFlowDisabledMessage': '클라이언트가 주어진 response_type으로 브라우저 로그인을 시작할 수 없습니다. 클라이언트에서 암시적 플로우가 비활성화되어 있습니다.',
  ...
  'resetCredentialNotAllowedMessage': '자격증명 재설정이 허용되지 않음',

  'permissionNotApprovedMessage': '권한이 승인되지 않았습니다.',
  'noRelayStateInResponseMessage': 'ID 제공자로부터의 응답에 릴레이 상태가 없습니다.',
  'insufficientPermissionMessage': 'ID를 연결하기 위한 권한이 부족합니다.',
  'couldNotProceedWithAuthenticationRequestMessage': 'ID 제공자에 대한 인증 요청을 진행할 수 없습니다.',
  'couldNotObtainTokenMessage': 'ID 제공자로부터 토큰을 얻을 수 없습니다.',
  'unexpectedErrorRetrievingTokenMessage': 'ID 제공자로부터 토큰을 검색하는 중 예상치 못한 오류가 발생했습니다.',
  'unexpectedErrorHandlingResponseMessage': 'ID 제공자로부터의 응답을 처리하는 중 예상치 못한 오류가 발생했습니다.',
  'identityProviderAuthenticationFailedMessage': '인증에 실패했습니다. ID 제공자로 인증할 수 없습니다.',
  'couldNotSendAuthenticationRequestMessage': 'ID 제공자에 인증 요청을 보낼 수 없습니다.',
  'unexpectedErrorHandlingRequestMessage': 'ID 제공자에 대한 인증 요청을 처리하는 중 예상치 못한 오류가 발생했습니다.',
  'invalidAccessCodeMessage': '잘못된 액세스 코드입니다.',
  'sessionNotActiveMessage': '세션이 활성화되지 않았습니다.',
  'invalidCodeMessage': '오류가 발생했습니다. 애플리케이션을 통해 다시 로그인해주세요.',
  'cookieNotFoundMessage': '로그인 재시작 쿠키를 찾을 수 없습니다. 만료되었거나 삭제되었거나 브라우저에서 쿠키가 비활성화되어 있을 수 있습니다. 쿠키가 비활성화되어 있으면 활성화하세요. 다시 로그인하려면 애플리케이션으로 돌아가기를 클릭하세요.',
  'insufficientLevelOfAuthentication': '요청된 인증 수준이 충족되지 않았습니다.',
  'identityProviderUnexpectedErrorMessage': 'ID 제공자로 인증하는 중 예상치 못한 오류가 발생했습니다',
  'identityProviderMissingStateMessage': 'ID 제공자로부터의 응답에 상태 매개변수가 누락되었습니다.',
  'identityProviderMissingCodeOrErrorMessage': 'ID 제공자로부터의 응답에 코드 또는 오류 매개변수가 누락되었습니다.',
  'identityProviderInvalidResponseMessage': 'ID 제공자로부터 잘못된 응답이 있습니다.',
  'identityProviderInvalidSignatureMessage': 'ID 제공자로부터의 응답에 잘못된 서명이 있습니다.',
  'identityProviderNotFoundMessage': '식별자로 ID 제공자를 찾을 수 없습니다.',
  'identityProviderLinkSuccess': '이메일을 성공적으로 인증했습니다. 원래 브라우저로 돌아가서 로그인을 계속하세요.',
  'staleCodeMessage': '이 페이지는 더 이상 유효하지 않습니다. 애플리케이션으로 돌아가서 다시 로그인하세요',
  'realmSupportsNoCredentialsMessage': '영역에서 자격증명 유형을 지원하지 않습니다.',
  'credentialSetupRequired': '로그인할 수 없습니다. 자격증명 설정이 필요합니다.',
  'identityProviderNotUniqueMessage': '영역에서 여러 ID 제공자를 지원합니다. 인증에 사용할 ID 제공자를 결정할 수 없습니다.',
  'emailVerifiedMessage': '이메일 주소가 인증되었습니다.',
  'emailVerifiedAlreadyMessage': '이메일 주소가 이미 인증되었습니다.',
  'staleEmailVerificationLink': '클릭한 링크는 오래된 링크로 더 이상 유효하지 않습니다. 이미 이메일을 인증했을 수 있습니다.',
  'identityProviderAlreadyLinkedMessage': '{0}에서 반환된 연합 ID가 이미 다른 사용자와 연결되어 있습니다.',
  'confirmAccountLinking': 'ID 제공자 {1}의 계정 {0} 연결을 확인하세요.',
  ...
  'missingParameterMessage': '매개변수 누락: {0}',
  ...
  'differentUserAuthenticated': '이 세션에서 이미 다른 사용자 "{0}"(으)로 인증되어 있습니다. 먼저 로그아웃하세요.',
  'brokerLinkingSessionExpired': '브로커 계정 연결이 요청되었지만 현재 세션이 더 이상 유효하지 않습니다.',
  'proceedWithAction': '&raquo; 계속하려면 여기를 클릭하세요',
  'acrNotFulfilled': '인증 요구사항이 충족되지 않았습니다',
  ...
  'console-verify-email': '이메일 주소를 인증해야 합니다. 인증 코드가 포함된 이메일을 {0}(으)로 보냈습니다. 아래 입력란에 이 코드를 입력하세요.',
  ...
  'saml.post-form.js-disabled': 'JavaScript가 비활성화되어 있습니다. 활성화하는 것을 강력히 권장합니다. 계속하려면 아래 버튼을 클릭하세요.',
  'saml.artifactResolutionServiceInvalidResponse': '아티팩트를 해결할 수 없습니다.',

  'otp-display-name': '인증 앱',
  'otp-help-text': '인증 앱에서 인증 코드를 입력하세요.',
  ...
  'auth-username-password-form-help-text': '사용자명과 비밀번호를 입력하여 로그인하세요.',
  ...
  'recovery-code-config-warning-title': '이 페이지를 떠나면 복구 코드가 다시 표시되지 않습니다',
  'recovery-code-config-warning-message': '반드시 인쇄하거나 다운로드하거나 패스워드 매니저에 복사해서 안전하게 보관하세요. 이 설정을 취소하면 계정에서 복구 코드가 제거됩니다.',
  'recovery-codes-print': '인쇄',
  'recovery-codes-download': '다운로드',
  'recovery-codes-copy': '복사',
  'recovery-codes-copied': '복사됨',
  'recovery-codes-confirmation-message': '이 코드들을 안전한 곳에 저장했습니다',
  ...
  'recovery-codes-download-file-description': '복구 코드는 인증앱에 액세스할 수 없을 때 계정에 로그인할 수 있는 일회용 패스코드입니다.',
  'recovery-codes-download-file-date': '이 코드들은 다음 날짜에 생성되었습니다',
  ...
  'passkey-unsupported-browser-text': '이 브라우저에서는 패스키가 지원되지 않습니다. 다른 브라우저를 사용하거나 관리자에게 문의하세요.',
  'passkey-doAuthenticate': '패스키로 로그인',
  'passkey-createdAt-label': '생성됨',
  'passkey-autofill-select': '패스키를 선택하세요',

  'identity-provider-redirector': '다른 ID 제공자와 연결',
  ...
  'accountUnusable': '이 계정으로는 애플리케이션을 더 이상 사용할 수 없음',
  'userDeletedSuccessfully': '사용자가 성공적으로 삭제되었습니다',

  'access-denied': '액세스 거부됨',
  'access-denied-when-idp-auth': '{0}로 인증할 때 액세스가 거부되었습니다',
  ...
  'readOnlyUsernameMessage': '사용자명이 읽기 전용이므로 업데이트할 수 없습니다.',
  'error-invalid-multivalued-size': '속성 {0}은(는) 최소 {1}개, 최대 {2}개의 {2,choice,0#값|1#값|1<값}을 가져야 합니다.',
  ...
  'organization.member.register.title': '${kc.org.name} 조직에 가입할 계정을 생성하세요',
  'organization.select': '진행할 조직을 선택하세요:',
  'notMemberOfOrganization': '사용자가 조직 {0}의 구성원이 아닙니다',
  'notMemberOfAnyOrganization': '사용자가 어떤 조직의 구성원도 아닙니다',
} as unknown as Record<MessageKey_defaultSet, string>;
