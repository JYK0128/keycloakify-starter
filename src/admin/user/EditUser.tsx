/**
 * This file has been claimed for ownership from @keycloakify/keycloak-admin-ui version 260200.0.1.
 * To relinquish ownership and restore this file to its original content, run the following command:
 *
 * $ npx keycloakify own --path "admin/user/EditUser.tsx" --revert
 */

import type { UserProfileConfig, UserProfileMetadata } from '@keycloak/keycloak-admin-client/lib/defs/userProfileMetadata';
import { TFunction } from 'i18next';
import { useState } from 'react';
import { FormProvider, useForm } from 'react-hook-form';
import { useTranslation } from 'react-i18next';
import { useNavigate } from 'react-router-dom';
import { AlertVariant, ButtonVariant, DropdownItem, Label, PageSection, Tab, TabTitleText, Tabs, Tooltip } from '../../shared/@patternfly/react-core';
import { InfoCircleIcon } from '../../shared/@patternfly/react-icons';
import { KeycloakSpinner, isUserProfileError, setUserProfileServerError, useAlerts, useFetch } from '../../shared/keycloak-ui-shared';
...
import { UIUserRepresentation, UserFormFields, filterManagedAttributes, toUserFormFields, toUserRepresentation } from './form-state';
