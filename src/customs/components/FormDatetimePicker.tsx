...
import { Button, Calendar, Input, Popover, PopoverContent, PopoverTrigger, Separator } from '#/shadcn/components/ui';
                ...
                <div className="flex flex-col">
                  ...
                  <div className="flex items-center gap-2 mt-2">
                    <Input
                      ...
                      max={23}
                      disabled={!selection}
                      className="caret-transparent cursor-default text-end"
