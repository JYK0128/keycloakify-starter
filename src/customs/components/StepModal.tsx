import { DIALOG, useDialog } from '#/customs/contexts/dialog';
import { StepModalContext } from '#/customs/contexts/step-modal';
import { Dialog, DialogTrigger } from '#/shadcn/components/ui';
import { MouseEventHandler, PropsWithChildren, ReactNode, useCallback, useMemo, useState } from 'react';
...
/** 모달창 */
export function StepModal<CACHE, DATA>({ children, render, closable, callback }: PropsWithChildren<Props>) {
