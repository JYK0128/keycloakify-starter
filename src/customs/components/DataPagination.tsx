import { Button, Pagination, PaginationContent, PaginationItem, Select, SelectContent, SelectItem, SelectTrigger, SelectValue } from '#/shadcn/components/ui';
    ...
    <div className="grid grid-cols-[1fr_auto_1fr] items-center">
      ...
      <div className="flex justify-between items-center gap-1">
        <Select defaultValue={`${pageSize}`} onValueChange={handleChangePageSize}>
          <SelectTrigger className="max-w-20 justify-self-end">
