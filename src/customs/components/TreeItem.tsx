import { TreeItemEditor, TreeItemEditorCallback, TreeNode } from '#/customs/components';
import { StepModal } from '#/customs/components/StepModal';
import { useDialog } from '#/customs/contexts';
import { useEventUtils } from '#/customs/hooks';
import { Button, Collapsible, CollapsibleContent, CollapsibleTrigger } from '#/shadcn/components/ui';
...
const styles = cva('', {
  variants: {
    action: {
      UP: 'border-t-blue-400 border-solid border-t-2',
      IN: 'bg-blue-400',
      DOWN: 'border-b-blue-400 border-solid border-b-2',
    },
    level: {
      false: '',
      true: 'pl-6',
